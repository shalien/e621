...
final class TagAlias extends Resource {
  ...
  /// Creates a [TagAlias] from a map.
  TagAlias.fromMap(Map<String, dynamic> map)
      : status = map['status'],
  ...
  bool operator ==(Object other) {
    ...
    if (other is! TagAlias) return false;
  ...
  @override
  String toString() {
    return 'TagAlias{status: $status, antecedentName: $antecedentName, consequentName: $consequentName, postCount: $postCount, reason: $reason, creatorId: $creatorId, approverId: $approverId, createdAt: $createdAt, updatedAt: $updatedAt, forumPostId: $forumPostId, forumTopic: $forumTopic, id: $id}';
  }
}
